item replace block ~ ~ ~ container.0 with command_block{clear:true,display:{Name:'"入力"'},code:1}
...
item replace block ~ ~ ~ container.17 with crafting_table{clear:true,display:{Name:'"出力"'},code:1}